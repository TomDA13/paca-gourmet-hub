...
const MissionSection = () => {
  ...
  return (
    <section id="mission" className="relative py-20 bg-white overflow-hidden">
      ...
      <div
        className="absolute bottom-24 left-20 w-24 h-24 bg-primary/15 rounded-full animate-pulse"
        style={{ animationDelay: "1.8s" }}
      ></div>
      <div
        className="absolute top-1/3 right-1/3 w-20 h-20 bg-accent/80 rounded-full animate-pulse"
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-gray-100 overflow-hidden">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-primary mb-3">
                  Une juste rémunération de nos producteurs partenaires
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  Avec qui nous travaillons <strong>main dans la main</strong> et que nous accompagnons{" "}
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-gray-100 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Fruits, légumes, BOF, viande, charcuterie et produits d'épicerie, tous sourcés dans la{" "}
                  <strong>région SUD PACA</strong>
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-gray-100 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Offrant des produits <strong>ultrafrais</strong> en <strong>circuits courts</strong>, dans le respect
                  de la <strong>chaîne du froid</strong>, et avec des DDM et DLC longues
                </p>
              </div>
            </div>
