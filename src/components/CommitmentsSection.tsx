...
const CommitmentsSection = () => {
  return (
    <section id="commitments" className="relative py-20 bg-primary/40 text-white overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          <div className="bg-white/15 backdrop-blur-sm p-8 rounded-xl text-center hover:bg-white/25 hover:scale-105 transition-all duration-300 cursor-pointer hover:shadow-xl border border-white/20">
        ...
        <div className="text-center">
          <Button 
            variant="secondary"
            className="bg-white/95 text-primary hover:bg-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 text-lg py-6 px-8 group font-semibold border border-white/30"
